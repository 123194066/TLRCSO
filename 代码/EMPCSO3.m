function [Best_Score, Convergence_curve, BestFit, f1_zong, f2_zong, f3_zong, f4_zong, BestIndex] = EMPCSO3(SearchAgents_no, dim, Max_iteration, ub, lb, pos_tag, all_param)
% % 改小鸡
r_num = dim / 2;
Tma = Max_iteration - 1;
G = 2;
...
for t = 1:Tma
       disp(['EMPCSO3 iteration = ', num2str(t), '   ', 'BEST Fitness = ', num2str(fMin)]);

function [Best_Score, Convergence_curve, BestFit, f1_zong, f2_zong, f3_zong, f4_zong, BestIndex] = EMPCSO1(SearchAgents_no, dim, Max_iteration, ub, lb, pos_tag, all_param)
% 加入截断高斯,指数衰减，衰减公式0.7*exp(-0.005*t+0.3)
...
for t = 1:Tma
    disp(['EMPCSO1 iteration = ', num2str(t), '   ', 'BEST Fitness = ', num2str(fMin)]);
